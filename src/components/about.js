    ...
    return(
        <div className="w-full flex space-x-8 h-screen p-32 pt-48 pb-16 text-center">
            ...
            <div className="w-3/4 border-primaryColor space-y-4 border-2 shadow-2xl shadow-primaryColor rounded-md p-10 pt-2">
                ...
                <p className='text-left text-primaryColor font-secondaryFont'><span className='text-helperColor'>"Food Manor"</span> is a user-friendly web application designed to simplify the process of finding and ordering food from various restaurants. Built using the <span className='text-helperColor'>MERN (MongoDB, Express.js, React, Node.js)</span> stack, this platform offers a seamless and responsive user experience.<br/>The core functionality of Food Manor revolves around presenting a diverse selection of restaurants along with their menu items. Users can effortlessly browse through a variety of cuisines and dishes, making it easy to explore their culinary options.<br/>To keep its content up-to-date and comprehensive, Food Manor employs a <span className='text-helperColor'>context-driven API</span> that extracts restaurant details directly from the Swiggy web page. This ensures that users have access to accurate and current information about the restaurants available on the platform.<br/>In addition to its functional aspects, Food Manor incorporates a <span className='text-helperColor'>shimmer UI effect</span>, enhancing the user interface with subtle animations and transitions. This not only makes the app visually appealing but also provides a smooth and enjoyable browsing experience.<br/>For users looking for a specific restaurant, Food Manor offers a convenient <span className='text-helperColor'>search feature</span>. This search functionality allows users to quickly locate their preferred restaurant by name.</p>
            </div>
        </div>
    );
};
