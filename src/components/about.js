...
const About=()=>{
    return(
        <div className="min-h-screen">
            <div className="w-full flex space-x-8 text-center justify-center pt-36 p-16 text-lg pb-16">
            <div className="w-1/4 border-primaryColor space-y-4 border-2 shadow-2xl shadow-primaryColor rounded-md p-4">
                ...
                <p className=' text-primaryColor'>Web App Devloper | Competitive Programmar</p>
